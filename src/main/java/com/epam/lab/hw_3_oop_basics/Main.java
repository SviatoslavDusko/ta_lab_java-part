...
public class Main {
    public static void main(String[] args) {
        LinkedList<Goods> allGods = new LinkedList<>();
        LinkedList<Goods> filteredLinkedList;
        Main main = new Main();

        main.fillUpList(allGods);
        filteredLinkedList = allGods;

        main.printList(filteredLinkedList);

        filteredLinkedList = main.filteredByPrice(filteredLinkedList, 700, true);//price from 700
        main.printList(filteredLinkedList);

        filteredLinkedList = main.filteredByPrice(filteredLinkedList, 1500, false);//price to 700
        main.printList(filteredLinkedList);

        filteredLinkedList = main.filteredByName(filteredLinkedList, "Door");//only Door return
        main.printList(filteredLinkedList);
    }
